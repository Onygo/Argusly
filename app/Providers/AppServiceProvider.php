...
use App\Policies\BrandGrowthAudienceProposalPolicy;
use App\Policies\BrandGrowthPlanFindingPolicy;
use App\Policies\BrandGrowthPlanPolicy;
...
use App\Policies\ContentPageLinkPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(BrandGrowthPlan::class, BrandGrowthPlanPolicy::class);
        Gate::policy(BrandGrowthPlanFinding::class, BrandGrowthPlanFindingPolicy::class);
        Gate::policy(BrandGrowthAudienceProposal::class, BrandGrowthAudienceProposalPolicy::class);
        ...
        Gate::policy(ContentPageLink::class, ContentPageLinkPolicy::class);
