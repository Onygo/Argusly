...
class DomainEvent extends Model
{
    ...
    public const TYPES = [
        ...
        'ContentPlanCreated',
        'ContentDraftCreatedFromBriefing',
        'ContentDraftGenerationRequested',
        'GeneratedDraftApplied',
        'ContentDistributionBundlePrepared',
        'ContentAuditCompleted',
        'LifecycleScoreCalculated',
        'LifecycleRefreshRecommendationCreated',
        'MentionCaptured',
        ...
        'InfluencerCreatorCreated',
        'InfluencerCreatorMonitored',
        'InfluencerCampaignTracked',
        'InfluencerCrmUpdated',
        'AgentRunStarted',
        'AgentRunCompleted',
        'AgentTaskPlanned',
        'AgentTaskApproved',
        ...
        'CommercialOverageRecorded',
        'MollieCheckoutCreated',
        'LlmRequestCompleted',
        'LlmRequestFailed',
        'LlmCreditsConsumed',
        'NarrativeCreated',
