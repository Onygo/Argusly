...
class PublishLayerTrackingDefaults
{
    /**
    ...
    private function shouldSeed(ClientSite $site): bool
    {
        ...
        foreach ($haystacks as $value) {
            if ($value !== '' && Str::contains($value, 'publishlayer')) {
                return true;
            }
        }
    ...
    private function defaultsForSite(ClientSite $site): array
    {
        ...
        return [
            [
                ...
                'brand_terms' => ['PublishLayer', 'PublishLayer SEO', 'PublishLayer platform'],
            ...
            [
                ...
                'target_brand' => 'PublishLayer',
                'target_domain' => $baseUrl !== '' ? parse_url($baseUrl, PHP_URL_HOST) : null,
                'brand_terms' => ['PublishLayer', 'PublishLayer AI', 'PublishLayer GEO'],
            ...
            [
                ...
                'name' => 'Brand Presence - PublishLayer',
                'query_text' => 'PublishLayer what is PublishLayer PublishLayer review PublishLayer SEO tool PublishLayer AI content platform',
                'target_brand' => 'PublishLayer',
                'target_domain' => $baseUrl !== '' ? parse_url($baseUrl, PHP_URL_HOST) : null,
                'brand_terms' => ['PublishLayer', 'Publish Layer', 'PublishLayer AI', 'PublishLayer platform'],
