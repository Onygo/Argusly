...
class StoreContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'market' => ['nullable', 'string', 'max:190'],
            'competitors' => ['nullable', 'string', 'max:1000'],
            'growth_goal' => ['nullable', 'string', 'max:190'],
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'competitors' => trim((string) $this->input('competitors', '')),
            'growth_goal' => trim((string) $this->input('growth_goal', '')),
            'interest_area' => trim((string) $this->input('interest_area', '')),
