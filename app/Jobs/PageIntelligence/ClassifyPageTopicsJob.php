...
class ClassifyPageTopicsJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(PageAnalysisService $analysis): void
    {
        ...
        $analysis->classifyTopics($snapshot);
    }

    public function middleware(): array
    {
        return [(new WithoutOverlapping('page-intelligence:topics:'.$this->pageSnapshotId))->releaseAfter(60)->expireAfter(600), new PageIntelligenceHostRateLimit];
    }
