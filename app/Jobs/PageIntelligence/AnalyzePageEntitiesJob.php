...
class AnalyzePageEntitiesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(PageAnalysisService $analysis): void
    {
        ...
        $analysis->analyzeEntities($snapshot);
    }

    public function middleware(): array
    {
        return [(new WithoutOverlapping('page-intelligence:entities:'.$this->pageSnapshotId))->releaseAfter(60)->expireAfter(600), new PageIntelligenceHostRateLimit];
    }
