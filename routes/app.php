...
Route::middleware(['auth', 'app.locale', 'support.context:app', 'support.readonly', 'email.code.verified', 'user.approved', 'user.org', 'onboarding.billing'])
    ->group(function () {
        ...
        Route::middleware(['ensure.feature.enabled:agentic_marketing'])->group(function () {
            ...
            Route::post('/agentic-marketing/workflows/run', [App\Http\Controllers\App\AppAutonomousMarketingWorkflowController::class, 'run'])->name('app.agentic-marketing.workflows.run');
            Route::post('/agentic-marketing/workflows/rules', [App\Http\Controllers\App\AppAutonomousMarketingWorkflowController::class, 'storeRule'])->name('app.agentic-marketing.workflows.rules.store');
            Route::post('/agentic-marketing/workflows/overrides', [App\Http\Controllers\App\AppAutonomousMarketingWorkflowController::class, 'storeOverride'])->name('app.agentic-marketing.workflows.overrides.store');
            Route::post('/agentic-marketing/workflows/overrides/{override}/clear', [App\Http\Controllers\App\AppAutonomousMarketingWorkflowController::class, 'clearOverride'])->name('app.agentic-marketing.workflows.overrides.clear');
        ...
        Route::get('/content/lifecycle', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'index'])->name('app.content.lifecycle.index');
        Route::post('/content/lifecycle/analyze', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'analyze'])->name('app.content.lifecycle.analyze');
        ...
        Route::post('/content/{content}/lifecycle/transition', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'transition'])->name('app.content.lifecycle.transition');
        Route::post('/content/{content}/lifecycle/send-to-review', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'sendToReview'])->name('app.content.lifecycle.send-to-review');
        Route::post('/content/{content}/lifecycle/approve', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'approve'])->name('app.content.lifecycle.approve');
        Route::post('/content/{content}/lifecycle/reject', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'reject'])->name('app.content.lifecycle.reject');
        Route::post('/content/{content}/lifecycle/assign', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'assign'])->name('app.content.lifecycle.assign');
        Route::post('/content/{content}/lifecycle/set-reviewer', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'setReviewer'])->name('app.content.lifecycle.set-reviewer');
        Route::post('/content/{content}/lifecycle/mark-refresh-needed', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'markRefreshNeeded'])->name('app.content.lifecycle.mark-refresh-needed');
        Route::get('/content/{content}/lifecycle/history', [App\Http\Controllers\App\ContentLifecycleDashboardController::class, 'lifecycleHistory'])->name('app.content.lifecycle.history');
        ...
        Route::get('/brand/company-intelligence', [\App\Http\Controllers\App\AppCompanyIntelligenceController::class, 'index'])->name('app.brand.company-intelligence');
        Route::post('/brand/company-intelligence', [\App\Http\Controllers\App\AppCompanyIntelligenceController::class, 'store'])->name('app.brand.company-intelligence.store');
        Route::post('/brand/company-intelligence/{profile}', [\App\Http\Controllers\App\AppCompanyIntelligenceController::class, 'update'])->name('app.brand.company-intelligence.update');
        Route::delete('/brand/company-intelligence/{profile}', [\App\Http\Controllers\App\AppCompanyIntelligenceController::class, 'destroy'])->name('app.brand.company-intelligence.delete');
        Route::get('/brand/company-intelligence/{profile}.json', [\App\Http\Controllers\App\AppCompanyIntelligenceController::class, 'showJson'])->name('app.brand.company-intelligence.json');
