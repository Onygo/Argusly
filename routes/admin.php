...
use App\Http\Controllers\Admin\AdminCreditReservationsController;
...
use App\Http\Controllers\Admin\AdminMosProviderController;
...
use App\Http\Controllers\Admin\AdminSupportModeController;
...
Route::middleware('admin.locale')->group(function () {
    ...
    Route::middleware(['auth', 'admin.area', 'support.context:admin', 'support.readonly'])
        ->group(function () {
            ...
            Route::get('/support', [AdminSupportModeController::class, 'index'])->name('admin.support.index');
            Route::post('/support/start', [AdminSupportModeController::class, 'start'])->name('admin.support.start');
            Route::post('/support/stop', [AdminSupportModeController::class, 'stop'])->name('admin.support.stop');
            Route::get('/support/diagnostics', [AdminSupportModeController::class, 'diagnostics'])->name('admin.support.diagnostics');
            Route::get('/support/snapshot', [AdminSupportModeController::class, 'snapshot'])->name('admin.support.snapshot');
            ...
            Route::middleware('can:admin-area-manage-approvals')->group(function () {
                ...
                Route::get('/mos/providers', [AdminMosProviderController::class, 'index'])->name('admin.mos-providers.index');
            ...
            Route::middleware('can:admin-area-manage-billing')->group(function () {
                ...
                Route::get('/credit-reservations', [AdminCreditReservationsController::class, 'index'])->name('admin.credit-reservations.index');
                Route::get('/credit-reservations/{reservation}', [AdminCreditReservationsController::class, 'show'])->name('admin.credit-reservations.show');
                Route::post('/credit-reservations/{reservation}/release', [AdminCreditReservationsController::class, 'release'])->name('admin.credit-reservations.release');
                Route::post('/credit-reservations/{reservation}/capture', [AdminCreditReservationsController::class, 'capture'])->name('admin.credit-reservations.capture');
                Route::post('/credit-reservations/bulk-release', [AdminCreditReservationsController::class, 'bulkRelease'])->name('admin.credit-reservations.bulk-release');
                Route::post('/credit-reservations/expire-stale', [AdminCreditReservationsController::class, 'expireStale'])->name('admin.credit-reservations.expire-stale');
            });
