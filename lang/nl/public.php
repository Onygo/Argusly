...
return [
    ...
    'landing' => [
        ...
        'integration_input_title' => 'Input monitoring',
        'integration_input_subtitle' => 'Signalen uit markt, site en content.',
        'integration_argus_title' => 'Vele ogen van Argusly',
        'integration_argus_subtitle' => 'Observeert, beoordeelt en bewaakt.',
        'integration_process_title' => 'Verwerking en API',
        'integration_delivery' => 'Data, workflows en besluiten.',
        'integration_output_title' => 'Uitgaande acties',
        'integration_output_subtitle' => 'Publicatie, sync en distributie.',
        'integration_text' => 'Argusly bewaakt inkomende signalen, verwerkt data tot gecontroleerde workflows en stuurt content, inzichten en acties door naar je connectors en kanalen.',
        'integration_api_label' => 'JSON API',
        'integration_inputs' => ['Briefs', 'SEO', 'GEO', 'Analytics'],
        'integration_processes' => ['Governance', 'Signals', 'Content', 'Audit'],
        'integration_targets' => [
            [
                'icon' => 'WP',
                'title' => 'WordPress',
