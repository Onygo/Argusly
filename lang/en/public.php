...
return [
    ...
    'footer' => [
        ...
        'reddit_join' => 'Join the discussion on Reddit',
        'linkedin_follow' => 'Follow Argusly on LinkedIn',
        'blog' => 'Blog',
        'legal_hub' => 'Legal hub',
        'privacy' => 'Privacy',
        'terms' => 'Terms',
    ...
    'pages' => [
        ...
        'company.roadmap' => [
            ...
            'metaDescription' => 'Explore the Argusly roadmap: from governed AI content creation to intelligence, planning, publishing, first-party analytics, revenue intelligence, and autonomous marketing capabilities.',
            'heading' => 'Argusly Roadmap',
            'intro' => 'Argusly is evolving into a governed marketing operating system that helps teams discover opportunities, plan campaigns, create content, publish across channels, measure impact, and continuously improve.',
            'sections' => [
                ['title' => 'Capability roadmap', 'bullets' => ['Foundation and governance', 'Market intelligence and planning', 'Creation, distribution, measurement, revenue intelligence, and autonomy']],
                ['title' => 'Product direction', 'bullets' => ['Roadmap work reflects planned direction and evolving capabilities.', 'Priorities may change based on customer needs, reliability, security, compliance, and market developments.']],
            ],
        ],
        'legal.index' => [
    ...
    'about' => [
        ...
        'community_text' => 'Discuss AI Search, GEO, marketing intelligence, feature ideas, and product feedback with the team and other builders.',
        'community_cta' => 'Join the discussion on Reddit',
    ...
    'roadmap' => [
        ...
        'hero_subtitle' => 'From AI content generation to an Agentic Marketing Operating System.',
        'hero_intro' => 'Argusly is evolving into a governed marketing operating system that helps teams discover opportunities, plan campaigns, create content, publish across channels, measure impact, and continuously improve. This roadmap shows the capabilities we are building toward, not a fixed list of feature promises.',

        'capabilities_eyebrow' => 'Capability roadmap',
        'capabilities_title' => 'The platform direction we are building toward',
        'capabilities_text' => 'Each area represents a planned direction or evolving capability across the Argusly Agentic Marketing Operating System.',
        'capabilities' => [
            [
                'icon' => 'layers',
                'title' => 'Foundation: Platform & Governance',
                'status' => 'Now available / in progress',
                'text' => 'The platform layer that makes Argusly reusable, governed, and scalable.',
                'items' => ['Universal Application Shell', 'Universal DataTable', 'Universal Action Registry', 'Universal Resource Registry', 'Universal Interaction Framework', 'Universal Drawer Engine', 'Universal Command Engine', 'Multi-tenant architecture', 'AI Governance & Transparency', 'Role-based access and auditability'],
            ],
            [
                'icon' => 'radar',
                'title' => 'Intelligence: Understand the Market',
                'status' => 'In progress / expanding',
                'text' => 'The layer that helps companies understand where demand, visibility, and competitive pressure are shifting.',
                'items' => ['AI Visibility', 'Opportunity Intelligence', 'Competitive Intelligence', 'Market Intelligence', 'AI Search Monitoring', 'Brand Mention Intelligence', 'AI Recommendation Tracking', 'Content Gap Detection'],
            ],
            [
                'icon' => 'map',
                'title' => 'Planning: From Insights to Strategy',
                'status' => 'In progress',
                'text' => 'The bridge between intelligence and execution.',
                'items' => ['Campaign planning', 'SEO and GEO planning', 'Content strategy', 'Market-specific briefing generation', 'Opportunity scoring', 'AI-assisted prioritization', 'Editorial calendars', 'Briefing workflows'],
            ],
            [
                'icon' => 'pen-tool',
                'title' => 'Creation: AI-assisted Content & Assets',
                'status' => 'Now available / expanding',
                'text' => 'Controlled content creation with human review, brand consistency, and governance.',
                'items' => ['Article generation', 'Landing page generation', 'LinkedIn post generation', 'Campaign copy', 'Multi-language content', 'Governance checks', 'Human review', 'Brand consistency'],
            ],
            [
                'icon' => 'send',
                'title' => 'Distribution: Publish Everywhere',
                'status' => 'Now available / expanding',
                'text' => 'Governed multi-channel publishing for websites, blogs, LinkedIn, and campaigns.',
                'items' => ['Website publishing', 'Blog publishing', 'LinkedIn publishing', 'Scheduled publishing', 'Approval flows', 'Campaign pages', 'Content localization', 'Channel-specific variants'],
            ],
            [
                'icon' => 'bar-chart-3',
                'title' => 'Measurement: First-party Marketing Analytics',
                'status' => 'Upcoming / in progress',
                'text' => 'First-party measurement without building a Google Analytics clone.',
            ...
            [
                ...
                'text' => 'Connecting marketing intelligence to commercial action.',
                'items' => ['Own CRM layer', 'Contact intelligence', 'Company intelligence', 'Sales pipeline', 'LinkedIn integration direction', 'Buying signals', 'Lead qualification', 'Opportunity follow-up'],
            ],
            [
                'icon' => 'refresh-cw',
                'title' => 'Autonomy: Toward Autonomous Growth',
                'status' => 'Future direction',
                'text' => 'The long-term direction: not replacing teams, but giving teams an operating system that can continuously detect, plan, execute, measure, and improve.',
                'items' => ['AI Teams', 'Marketing Agents', 'Sales Agents', 'Research Agents', 'Planning Agents', 'Execution Agents', 'Review Agents', 'Autonomous campaigns', 'Autonomous SEO/GEO', 'Autonomous reporting', 'Continuous optimization'],
            ],
        ],

        'disclaimer_eyebrow' => 'Product direction',
        'disclaimer_title' => 'A roadmap, not a promise list',
        'disclaimer_text' => 'This roadmap reflects our current product direction. Priorities may change based on customer needs, platform reliability, security, compliance, and market developments.',
        'principles' => [
            'Capabilities move from now available to in progress, upcoming, or future direction as they mature.',
            'Customer needs, production usage, and rollout work shape sequencing.',
            'Reliability, security, compliance, and governance remain product constraints, not afterthoughts.',
            'The roadmap is intended to clarify direction without creating fixed feature promises.',
        ],

        'cta_title' => 'Want to influence the roadmap?',
        'cta_text' => 'Active customers have direct input into product direction. Start with the pilot program or contact us to discuss your requirements.',
    ],
];
