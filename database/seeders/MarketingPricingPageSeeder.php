        ...
        return [
            'en' => [
                'hero' => [
                    ...
                    'supporting_text' => 'More than AI writing. Argusly manages the full content lifecycle.',
                ...
                'comparison' => [
                    ...
                    'rows' => [
                        ...
                        ['label' => 'CMS publishing workflows', 'argusly' => true, 'alternative' => false],
                ...
                'faq' => [
                    ['question' => 'Is Argusly just an AI writer?', 'answer' => 'No. Argusly is a content operations platform for planning, generation, optimization, localization, governance and publishing orchestration.'],
                    ...
                    ['question' => 'Can I publish directly to WordPress?', 'answer' => 'Yes. Argusly supports WordPress publishing workflows, and higher plans add API-driven delivery paths.'],
            ...
            'nl' => [
                'hero' => [
                    ...
                    'supporting_text' => 'Meer dan AI writing. Argusly beheert de volledige content lifecycle.',
                ...
                'comparison' => [
                    ...
                    'rows' => [
                        ...
                        ['label' => 'CMS-publicatieworkflows', 'argusly' => true, 'alternative' => false],
                        ['label' => 'Editorial collaboration', 'argusly' => true, 'alternative' => false],
                        ['label' => 'Content lifecycle management', 'argusly' => true, 'alternative' => false],
                        ['label' => 'Multi-brand operations', 'argusly' => true, 'alternative' => false],
                    ],
                ...
                'faq' => [
                    ['question' => 'Is Argusly alleen een AI writer?', 'answer' => 'Nee. Argusly is een content operations platform voor planning, generatie, optimalisatie, lokalisatie, governance en publishing orchestration.'],
                    ...
                    ['question' => 'Kan ik direct naar WordPress publiceren?', 'answer' => 'Ja. Argusly ondersteunt WordPress-publicatieworkflows en hogere plannen voegen API-gestuurde delivery toe.'],
