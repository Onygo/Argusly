...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('publishlayer_webhook_events', function (Blueprint $table) {
            if (! $this->hasIndex('publishlayer_webhook_events', 'publishlayer_webhook_events_site_received_idx')) {
                $table->index(['site_key', 'received_at'], 'publishlayer_webhook_events_site_received_idx');
            }

            if (! $this->hasIndex('publishlayer_webhook_events', 'publishlayer_webhook_events_site_status_idx')) {
                $table->index(['site_key', 'status'], 'publishlayer_webhook_events_site_status_idx');
            }
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('publishlayer_webhook_events', function (Blueprint $table) {
            if ($this->hasIndex('publishlayer_webhook_events', 'publishlayer_webhook_events_site_received_idx')) {
                $table->dropIndex('publishlayer_webhook_events_site_received_idx');
            }

            if ($this->hasIndex('publishlayer_webhook_events', 'publishlayer_webhook_events_site_status_idx')) {
                $table->dropIndex('publishlayer_webhook_events_site_status_idx');
            }
