...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('marketing_observations', function (Blueprint $table): void {
            ...
            $table->foreign('marketing_metric_definition_id', 'marketing_observations_metric_definition_fk')
                ->references('id')
        ...
        Schema::create('marketing_observation_dimensions', function (Blueprint $table): void {
            ...
            $table->foreign('marketing_observation_id')
                ->references('id')
                ->on('marketing_observations')
                ->cascadeOnDelete();
            $table->foreign('marketing_dimension_definition_id', 'marketing_observation_dimensions_definition_fk')
                ->references('id')
