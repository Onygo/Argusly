@php
    ...
    $classes = match ($statusValue) {
        ...
        'draft', 'pending', 'running', 'warning' => 'border-amber-200 bg-amber-50 text-amber-800',
        'inactive', 'skipped', 'cancelled' => 'border-slate-200 bg-slate-50 text-slate-700',
        'expired', 'revoked', 'error', 'failed', 'critical' => 'border-rose-200 bg-rose-50 text-rose-800',
