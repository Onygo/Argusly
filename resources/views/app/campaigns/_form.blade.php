...
<div class="grid gap-4 sm:grid-cols-2">
    <label class="block sm:col-span-2">
        ...
        <input name="name" value="{{ old('name', $campaign->name) }}" required class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    </label>

    <label class="block">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">Slug</span>
        <input name="slug" value="{{ old('slug', $campaign->slug) }}" placeholder="Generated from name" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    </label>

    <label class="block">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">Type</span>
        <select name="campaign_type" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    ...
    <label class="block">
        ...
        <input name="start_date" type="date" value="{{ old('start_date', $campaign->start_date?->format('Y-m-d')) }}" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    </label>

    <label class="block">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">End date</span>
        <input name="end_date" type="date" value="{{ old('end_date', $campaign->end_date?->format('Y-m-d')) }}" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    </label>

    <label class="block sm:col-span-2">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">Objective</span>
        <textarea name="objective" rows="3" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">{{ old('objective', $campaign->objective) }}</textarea>
    </label>

    <label class="block sm:col-span-2">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">Description</span>
        <textarea name="description" rows="4" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">{{ old('description', $campaign->description) }}</textarea>
    </label>

    <label class="block">
        <span class="text-xs font-semibold uppercase tracking-[0.1em] text-muted">Content assets</span>
        <select name="content_asset_ids[]" multiple size="7" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    ...
    <label class="block">
        ...
        <select name="topic_ids[]" multiple size="7" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
    ...
    <label class="block sm:col-span-2">
        ...
        <select name="signal_ids[]" multiple size="7" class="mt-2 w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
