@props([
    ...
    'schematic' => null,
    'showChrome' => false,
    'desktopWrapperClass' => 'mx-auto hidden max-w-4xl rounded-md border border-border bg-surface md:block',
    'desktopInnerClass' => 'p-5 md:p-8',
])

<div class="mx-auto flex w-full max-w-4xl justify-center px-4 sm:px-6 md:hidden">
    <div class="w-full max-w-[21rem] rounded-md border border-border bg-white p-2.5">
        <div class="overflow-hidden rounded-md border border-border bg-[#f3f1ec]">
            ...
            <div class="space-y-3.5 p-4">
                <div class="rounded-md border border-border bg-white p-3.5">
                    <div class="h-28 rounded-md bg-[#e2ddd4]"></div>
                ...
                <div class="grid grid-cols-2 gap-3.5">
                    <div class="rounded-md border border-border bg-white p-3.5">
                        <div class="h-12 rounded-md bg-[#e2ddd4]"></div>
                ...
                <div class="rounded-md border border-border bg-white p-3.5">
                    <div class="flex items-center gap-2.5">
                        <div class="h-9 w-9 rounded-md bg-[#e2ddd4]"></div>
                        <div class="flex-1">
