...
<div class="rounded-lg border border-line bg-white p-4">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <label class="w-24">
            ...
            <input name="positions[{{ $section->id }}]" type="number" min="0" value="{{ $section->position }}" class="mt-1 w-full rounded-lg border border-line bg-panel px-3 py-2 text-sm text-ink">
        </label>
    </div>
