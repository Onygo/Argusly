...
@section('pageHeader')
    <x-page-header title="Credit Reservations">
        <x-slot:description>Manage credit reservations for AI operations.</x-slot:description>
    </x-page-header>
@endsection
...
@section('metricSection')
    <x-metric-section>
        <x-metric-card label="Active Reservations" :value="$stats['total_reserved']" />
        <x-metric-card label="Reserved Credits" :value="number_format($stats['total_reserved_credits'])" />
        <x-metric-card label="Stale (Expired TTL)" :value="$stats['stale_count']" tone="warning" />
        <x-metric-card label="Stale Credits" :value="number_format($stats['stale_credits'])" tone="warning" />
        <x-metric-card label="Captured Today" :value="$stats['captured_today']" tone="success" />
        <x-metric-card label="Released Today" :value="$stats['released_today']" />
    </x-metric-section>
@endsection
