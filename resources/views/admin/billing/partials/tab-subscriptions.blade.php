<form method="GET" class="mb-4 grid gap-2 lg:grid-cols-4">
    ...
    <div class="lg:col-span-2 flex gap-2">
        ...
        <a href="{{ route('admin.organizations.billing', [$organization, 'tab' => 'subscriptions']) }}" class="rounded border border-border px-3 py-1.5 text-xs text-textSecondary">Reset</a>
    </div>
</form>
