        ...
        <nav class="flex-1 overflow-y-auto px-2 py-3">
            ...
            <div class="mb-4">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.early-access.index') }}" data-sidebar-item data-sidebar-title="Early access" class="group relative flex h-9 items-center justify-start gap-3 rounded-md px-3 text-sm font-medium transition-all {{ request()->routeIs('admin.early-access.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}">
                        ...
                        <span data-sidebar-label class="truncate">Early Access</span>
                        <span data-sidebar-tooltip class="pointer-events-none absolute left-full top-1/2 z-50 ml-2 hidden -translate-y-1/2 whitespace-nowrap rounded-md border border-border bg-surface px-2 py-1 text-xs text-textPrimary opacity-0 transition-opacity duration-150 group-hover:opacity-100">Early Access</span>
                    </a>
                    @can('admin-area-superadmin')
            ...
            <div class="fixed inset-y-0 left-0 w-72 bg-surface border-r border-border z-50">
                ...
                <nav class="space-y-3 p-4">
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.dashboard') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="layout-dashboard" class="h-4 w-4"></i> Dashboard</a>
                            <a href="{{ route('admin.system-health.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.system-health.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="heart-pulse" class="h-4 w-4"></i> System Health</a>
                            ...
                            @can('admin-area-superadmin')
                                <a href="{{ route('admin.llm.settings') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.llm.settings*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="sliders-horizontal" class="h-4 w-4"></i> LLM Settings</a>
                            @endcan
                            <a href="{{ route('admin.queues.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.queues.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="list-checks" class="h-4 w-4"></i> Queues</a>
                            <a href="{{ route('admin.campaigns.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.campaigns.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="network" class="h-4 w-4"></i> Campaigns</a>
                            <a href="{{ route('admin.webhooks.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.webhooks.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="webhook" class="h-4 w-4"></i> Webhooks</a>
                            <a href="{{ route('admin.sites') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.sites.*') || request()->routeIs('admin.sites') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="globe" class="h-4 w-4"></i> Sites</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.users') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.users') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="users" class="h-4 w-4"></i> Users</a>
                            <a href="{{ route('admin.early-access.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.early-access.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="rocket" class="h-4 w-4"></i> Early Access</a>
                            @can('admin-area-superadmin')
                                <a href="{{ route('admin.support.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.support.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="life-buoy" class="h-4 w-4"></i> Support</a>
                            @endcan
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.brand-profiles.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.brand-profiles.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="palette" class="h-4 w-4"></i> Default Brand Profiles</a>
                            <a href="{{ route('admin.content-policies.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.content-policies.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="shield-check" class="h-4 w-4"></i> Content Policies</a>
                            <a href="{{ route('admin.feature-flags.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.feature-flags.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="toggle-left" class="h-4 w-4"></i> Feature Flags</a>
                            <a href="{{ route('admin.announcements.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.announcements.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="megaphone" class="h-4 w-4"></i> Announcements</a>
                            <a href="{{ route('admin.product-updates.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.product-updates.*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="history" class="h-4 w-4"></i> Product Updates</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.billing.pricing-page.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.billing.pricing-page*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="tag" class="h-4 w-4"></i> Pricing Page</a>
                            <a href="{{ route('admin.invoices.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.invoices*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="receipt" class="h-4 w-4"></i> Invoices</a>
                        </div>
                    </div>
                    @can('admin-area-superadmin')
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="{{ route('admin.analytics.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm {{ request()->routeIs('admin.analytics*') ? 'border-l-2 border-l-primary bg-primarySoftBg text-textPrimary' : 'text-textSecondary hover:bg-surfaceMuted hover:text-textPrimary' }}"><i data-lucide="bar-chart-3" class="h-4 w-4"></i> Analytics</a>
                        </div>
                    </div>
                    @endcan
                </nav>
