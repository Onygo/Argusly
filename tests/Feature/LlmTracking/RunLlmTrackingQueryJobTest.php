...
it('creates a run record and updates flags when job succeeds', function () {
    ...
    $mock->shouldReceive('run')->once()->andReturn([
        ...
        'parsed_payload' => [
            'response_text' => 'PublishLayer is cited via https://publishlayer.com/features and compared with AcmeSEO.',
        ],
        'answer_text' => 'PublishLayer is cited via https://publishlayer.com/features and compared with AcmeSEO.',
        'brand_hits' => [['term' => 'PublishLayer', 'count' => 1, 'bucket' => 'first']],
        'competitor_hits' => [['term' => 'AcmeSEO', 'count' => 1, 'bucket' => 'last']],
        'entity_presence' => [
            ['term' => 'PublishLayer', 'type' => 'brand', 'present' => true, 'count' => 1, 'position_score' => 1.0],
            ['term' => 'AcmeSEO', 'type' => 'competitor', 'present' => true, 'count' => 1, 'position_score' => 0.2],
        ],
        'url_hits' => [['target_url' => 'https://publishlayer.com/features', 'count' => 1, 'bucket' => 'middle']],
        'citation_ranking' => ['brand' => ['bucket' => 'first'], 'url' => ['bucket' => 'middle']],
        'sources' => [['url' => 'https://publishlayer.com/features', 'domain' => 'publishlayer.com', 'type' => 'website']],
...
it('uses cached run for identical same-day runs without extra quota usage', function () {
    ...
    $mock->shouldReceive('run')->once()->andReturn([
        ...
        'model' => 'gpt-4.1-mini',
        'raw_response' => ['id' => 'resp_123'],
        'parsed_payload' => ['response_text' => 'PublishLayer via https://publishlayer.com/features.'],
        'answer_text' => 'PublishLayer via https://publishlayer.com/features.',
        'brand_hits' => [['term' => 'PublishLayer', 'count' => 1, 'bucket' => 'first']],
        'competitor_hits' => [],
        'entity_presence' => [
            ['term' => 'PublishLayer', 'type' => 'brand', 'present' => true, 'count' => 1, 'position_score' => 1.0],
...
it('dispatches due active queries with daily spreading command', function () {
    ...
    $second = LlmTrackingQuery::query()->create([
        ...
        'client_site_id' => $site->id,
        'name' => 'Due query',
        'query_text' => 'Who mentions PublishLayer?',
        'frequency' => 'daily',
        'is_active' => true,
        'locale' => 'en',
    ]);
