...
- Bestaande planfile: `/Users/ricardohagens/Sites/argusly/docs/argusly-functional-audit-argusly-plan.md`
...
| Argusly functie | Argusly status | Argusly equivalent | Beoordeling |
|---|---|---|---|
...
| Argusly structuur | Argusly functies die passen | Migratiehouding |
|---|---|---|
...
- AI visibility scoring en citation intelligence op Argusly-niveau.
...
- Argusly branding, public marketing pages, plugin licensing als zelfstandig productconcept.
- Legacy `/briefs`/`/drafts` navigatie en Argusly-specific route names.
